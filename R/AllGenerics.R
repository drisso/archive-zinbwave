...
#' 
#' Given an object that describes a dataset or a model involving genes, this function returns the number of genes.
...
#' @param object an object that describes a dataset or a model involving latent factors
...
#' @param object an object that describes a matrix of zero-inflated negative binomial
#' @param seed an optional integer to specify how the random number generator should be initialized with a call to \code{set.seed}. If missing, the random generator state is not changed.
#' @return the matrix of probabilities of 0
#' @examples
#' a=zinb_model(n=5,J=10)
#' simulateZINB(a) 
