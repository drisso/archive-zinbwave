...
$$
\hat{\gamma}_\pi \in \arg\min_{\gamma_\pi} \sum_{(i,j)} \left[-\hat{Z}_{ij} (V\gamma_\pi)_{ji} + \log\left( 1 + e^{(V\gamma_\pi)_{ji}}\right)  \right] + \frac{\epsilon_\gamma}{2} \|\gamma_\pi^0\|^2 \,.
$$
