...
$$
where $\text{Pen}(\cdot)$ is a regularization term to reduce overfitting and improve numerical stability of the optimization problem over many parameters. For a set of nonnegative regularization parameters $\left( \epsilon_\beta , \epsilon_\gamma, \epsilon_W, \epsilon_\alpha, \epsilon_\zeta \right)$, we take
$$
