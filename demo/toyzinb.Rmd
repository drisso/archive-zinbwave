...
We have also made a 5~10x faster and hopefully more stable version:
```{r message=FALSE}
ptm <- proc.time()
...
We see that the new version converges in less iterations, and in less time, to an apparently better solution. There is still much room for speed-up, in particular:
